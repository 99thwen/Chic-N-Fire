...

{
  ...
  title: "Pizza Deal 1",
  description:
    "1 Medium Pizza, 2 Zinger Burgers, 2 Regular Fries and a 1.5L Drink.",
  price: 2890,
...

{
  ...
  title: "Pizza Deal 2",
  description:
    "1 Medium Special Pizza, 1 Medium Supreme Pizza and 1.5L Drink.",
  price: 2450,
...

{
  ...
  title: "Pizza Deal 3",
  description:
    "1 Large Special Pizza, 1 Small Chicken Tikka Pizza and 1.5L Drink.",
  price: 2490,
...

{
  ...
  title: "Student Deal",
  description:
    "1 Small Supreme Pizza, 2 Zinger Burgers and 2 Regular Drinks.",
  price: 1860,
...

{
  ...
  title: "Zinger Meal",
  description:
    "1 Crispy Zinger Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 740,
...

{
  ...
  description:
    "1 Steam Zinger Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 740,
...

{
  ...
  category: "Deals",
  title: "WOW Meal 1",
  description: "1 Zinger Burger, 1 Chicken Piece and 1 Regular Drink.",
  price: 830,
...
},
{
  ...
  category: "Deals",
  title: "WOW Meal 2",
  description: "1 Zinger Burger, 1 Chicken Piece, 1 Regular Fries and 1 Regular Drink.",
  price: 990,
...
},
{
  ...
  category: "Deals",
  title: "WOW Meal 3",
  description: "3 Chicken Pieces served with 1 Regular Drink.",
  price: 850,
   available: true,
   order: 11, 
...

{
  ...
  category: "Deals",
  title: "Special Meal",
  description: "1 Special Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 920,
   available: true,
...
},
{
  ...
  title: "Fire Steak Meal",
   description: "1 Chicken Steak Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 920,
   available: true,
   order: 16, 
...

{
  ...
  title: "Mighty Zinger Meal",
    description: "1 Mighty Zinger Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 920,
   available: true,
   order: 13, 
...

{
  ...
  category: "Deals",
  title: "Tower Meal",
  description: "1 Tower Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 920,
   available: true,
   order: 17, 
...
},
{
  ...
  description: "1 Crisp Cheese Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 920,
   available: true,
   order: 18, 
...
},
{
  ...
  title: "Chicken Stuff Cheese Burger Meal",
    description: "1 Stuffed Cheese Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 890,
   available: true,
   order: 19, 
...
},
{
  ...
  title: "Tikka Stuff Cheese Meal",
    description: "1 Tikka Stuffed Cheese Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 890,
   available: true,
   order: 20, 
...
},
{
  ...
  title: "Beef Burger Meal",
    description: "1 Beef Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 890,
   available: true,
   order: 21, 
...
},
{
  ...
  category: "Deals",
  title: "Fish Meal",
  description: "1 Fish Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 890,
   available: true,
   order: 22, 
...
},
{
  ...
  description: "1 Jalapeno Cheese Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 790,
   available: true,
   order: 23, 
...
},
{
  ...
  description: "1 Fire Stone Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 650,
   available: true,
   order: 24, 
...
},
{
  ...
  description: "1 Chicken Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 680,
   available: true,
   order: 27, 
...
},
{
  ...
  description: "1 Chicken Grill Stuff Burger served with Regular Fries and 1 Regular Drink.",
  price: 920,
   available: true,
   order: 25, 
...
},
{
  ...
  category: "Deals",
  title: "Crispy Meal",
  description: "1 Crispy Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 680,
   available: true,
   order: 28, 
...
},
{
  ...
  category: "Deals",
  title: "Tikka Meal",
  description: "1 Tikka Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 680,
   available: true,
   order: 29, 
...
},
{
  ...
  description: "1 Chicken Grill Burger served with 1 Regular Fries and 1 Regular Drink.",
  price: 730,
   available: true,
   order: 26, 
  image: "/foods/meal18.webp",
...
},
{
  ...
  category: "Deals",
  title: "Wings Deal",
  description: "10 Hot Wings served with 1 Regular Fries and 1 Regular Drink.",
  price: 850,
   available: true,
   order: 30, 
...
},
{
  ...
  category: "Deals",
  title: "Fish Deal",
   description: "2 Fish Fillets served with 1 Regular Fries and 1 Regular Drink.",
  price: 890,
   available: true,
   order: 31, 
...
},
{
  ...
  category: "Deals",
  title: "2 Person Deal",
  description: "2 Zinger Burgers, 2 Chicken Pieces, 1 Large Fries and 2 Regular Drinks.",
  price: 2070,
   available: true,
   order: 1, 
...
},
{
  ...
  category: "Deals",
  title: "3 Person Deal",
  description: "3 Zinger Burgers, 1 Large Fries and a 1.5L Drink.",
  price: 2070,
  order: 2, 
   available: true,
...
},
{
  ...
  category: "Deals",
  title: "Family Deal 1",
  description: "4 Zinger Burgers, 4 Chicken Pieces, 2 Regular Fries, Arabian Rice and a 1.5L Drink.",
  price: 3560,
   available: true,
   order: 3, 
...
},
{
  id: 71,
  category: "Rice",
  title: "Rice & Spice (3 Chicken Wings)",
...

{
  id: 84,
  category: "Chicken",
  title: "Chicken Strips (6 Pieces with Fries & Dip",
description: "6 tender chicken strips coated in a crispy golden crust, served with fries and a dipping sauce.",
  price: 500,
  available: true,
  order: 19,
...

{
  id: 119,
  category: "Curley Fries",
  title: "Mayo Cheese Garlic Fries",
...

{
  id: 120,
  category: "Curley Fries",
  title: "Cheese Mayo Family Fries",
